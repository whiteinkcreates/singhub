...
import { getSingBoardEvent } from "@/lib/singboard/repository";
    ...
    <article className="mt-5 overflow-hidden rounded-[2rem] border border-white/10 bg-slate-950 shadow-2xl">
      ...
      <div className="p-6 sm:p-8">
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          {!ended&&event.linkUrl&&<a href={event.linkUrl} target="_blank" rel="noopener noreferrer" className="rounded-xl bg-fuchsia-500 px-5 py-3 text-center font-black text-white">Event / ticket info ↗</a>}
