    ...
    <main className="mx-auto max-w-7xl px-4 py-10 text-white">
      <div className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-3 max-w-3xl text-sm leading-6 text-slate-300">Turn today&apos;s question into a consistent social post, a stronger caption, and a direct path back to the vote.</p>
        </div>
